...
app.get("/movies",async(req,res)=>{
    ...
    // let queryMovies = movies
    // if(req.query.language){
    //     queryMovies = queryMovies.filter((mv)=>mv.language === req.query.language)
    // }
    // if(req.query.rating){
    //     queryMovies = queryMovies.filter((mv)=>mv.rating === +req.query.rating)
    // }
...
app.get("/movies/:id",async(req,res)=>{
    ...
    const { id } = req.params;
    // const movie = movies.find((mv)=>mv.id === req.params.id)
